...
--
-- Host: localhost    Database: parque
-- ------------------------------------------------------
...
CREATE TABLE `ticket_types` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tipo` enum('inteira','estudante','vip') NOT NULL,
...
CREATE TABLE `tickets` (
  ...
  CONSTRAINT `tickets_ibfk_1` FOREIGN KEY (`purchase_id`) REFERENCES `purchases` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-06-14  3:36:12
